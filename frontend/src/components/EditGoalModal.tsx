...
type EditGoalModalProps = {
    data: GoalForm;
    onEditGoal: (data: GoalForm) => void;
}

const EditGoalModal = (props: EditGoalModalProps) => {
    const { onEditGoal, data } = props;
                                        ...
                                        <FormControl>
                                            ...
                                            >
                                                <FormItem className="flex items-center space-x-3 space-y-0">
                                                    <FormControl>
                                                        <RadioGroupItem disabled={true} value={GoalType.ONE_TIME} />
                                                    </FormControl>
                                                ...
                                                <FormItem className="flex items-center space-x-3 space-y-0">
                                                    <FormControl>
                                                        <RadioGroupItem disabled={true} value={GoalType.WEEKLY} />
                                                    </FormControl>
                                                    <FormLabel className="font-normal">
                                                        Weekly goal
                                                    </FormLabel>
                                                ...
                                                <FormItem className="flex items-center space-x-3 space-y-0">
                                                    <FormControl>
                                                        <RadioGroupItem disabled={true} value={GoalType.DAILY} />
                                                    </FormControl>
                                                    <FormLabel className="font-normal">
                                                        Daily goal
                                                    </FormLabel>
